...
const TABS: ReadonlyArray<Tab> = [
  ...
  },
  {
    icon: "🔍",
    label: "Scanner",
    headline: "See what actually matters.",
    body: "The Wolf Scanner cuts through the noise. Real-time momentum data. The names in play, filtered for the setups that work.",
    image: "/screenshots/scanner.png",
    alt: "Wolf Scanner",
  },
  {
    icon: "🤖",
    label: "Wolf AI",
    headline: "Your AI trading companion.",
    body: "Wolf AI learns your process, your patterns, your setups. Ask it questions. Get session prep. Review your trades. Coming to Wolfpack Pro.",
